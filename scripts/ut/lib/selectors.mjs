...
export const DETAIL_CATEGORY = {
  skincare: '스킨케어', suncare: '선케어', makeup: '색조',
  cleansing: '클렌징', haircare: '헤어', etc: '기타',
};

export const DETAIL_TEMPLATE = {
  D1: '문제해결 서사형', D2: '성분 근거형', D3: '스펙·씬 신뢰형',
  D4: '컬러 배리에이션형', D5: '저자극·편의형', D6: '브랜드 프리미엄형',
};

export const THUMB_STYLE = {
  A: '클린 스튜디오 단독컷', B: '제품+텍스처 스와치', C: '공식샵 신뢰 배지형',
  D: '캐치카피+성분 비주얼형', E: '수상 실적 스택형', F: '모델+카피형',
  G: '프로모션 강조형', H: '프리미엄 무드형',
};
...
export const POSITIONING_TAGS = [
  ['sensitive', '민감 피부·저자극'], ['freeFormula', '무첨가·프리 처방'], ['ingredientLed', '성분 집중'],
  ['derma', '더마·피부과학'], ['cleanVegan', '클린·비건'], ['moisture', '보습·장벽'],
  ['calming', '진정 케어'], ['pore', '모공·피지 케어'], ['tone', '톤·브라이트닝'],
  ['firming', '탄력·안티에이징'], ['efficacy', '효능 근거·기능성'], ['mens', '남성 특화'],
  ['kTrend', 'K뷰티 트렌드'], ['value', '가성비'], ['sensorial', '향·질감 감성'], ['minimal', '미니멀 처방'],
];

export const REPORT_TAB_LABELS = ['시장', '진단', '처방'];

export const STAGE_LABEL = {
  extract: '원문 추출', normalize: '정규화', presignals: '사전 신호', llmCalls: '진단 생성',
  persona: '페르소나', aggregate: '집계', benchmark: '벤치마크', call4: '처방', assemble: '조립', humanize: '윤문',
  analyze: '분석', plan: '블록 설계', copy: '카피 생성', blocks: '블록 생성', compose: '결합', slice: '분할', gate: '검수',
  generate: '이미지 생성',
};
