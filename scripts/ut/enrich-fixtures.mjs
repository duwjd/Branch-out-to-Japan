...
const INGREDIENT_PURPOSE = {
  세라마이드NP: ['5%', '피부 장벽 보강'], 판테놀: ['3%', '진정·보습'], 마데카소사이드: ['0.2%', '진정'],
  히알루론산: ['2%', '수분 유지'], 병풀추출물: ['82%', '진정'], 아시아티코사이드: ['0.1%', '진정'],
  나이아신아마이드: ['5%', '피지·톤 정돈'], 아연PCA: ['1%', '피지 조절'], 살리실릭애씨드: ['0.5%', '각질 정리'],
  스쿠알란: ['3%', '유수분 밸런스'], 시어버터: ['5%', '보습 밀착'], 호호바씨오일: ['3%', '유연'],
  세라마이드: ['3%', '피부 장벽 보강'], 글리세린: ['5%', '보습'], 베타인: ['2%', '수분 유지'],
  녹차추출물: ['1%', '진정'], 징크옥사이드: ['12%', '자외선 차단'], 티타늄디옥사이드: ['8%', '자외선 차단'],
  아시아틱애씨드: ['0.1%', '진정'],
};

const HOW_TO = {
  skincare: ['세안 후 토너로 피부결을 정돈합니다.', '적당량을 덜어 얼굴 전체에 부드럽게 펴 발라 줍니다.', '손바닥으로 가볍게 감싸 흡수시킵니다.'],
  suncare: ['외출 15분 전, 얼굴 전체에 충분한 양을 발라 줍니다.', '목과 귀 뒤까지 놓치지 않고 펴 바릅니다.', '2~3시간마다 덧발라 줍니다.'],
  makeup: ['입술 결을 정돈한 뒤 사용합니다.', '팁을 입술 중앙에 대고 바깥쪽으로 펴 발라 줍니다.', '진하게 쓰고 싶으면 한 번 더 덧발라 줍니다.'],
  cleansing: ['젖은 손에 적당량을 덜어 거품을 냅니다.', '얼굴 전체를 부드럽게 마사지하듯 문질러 줍니다.', '미지근한 물로 깨끗이 헹궈 냅니다.'],
