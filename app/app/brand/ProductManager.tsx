...
const SPEC_FIELDS: { name: string; label: string; multiline?: boolean }[] = [
...
const REVIEW_REQUIRED = ['specFullIngredients', 'ingredientRows'];

/** 자동으로 채운 칸의 출처(BRAND-03b 3b-7). 값이 어디서 왔는지 화면이 반드시 말한다 */
type FieldOrigin = 'web' | 'source';
 ...
 */
function OriginNote({ origin }: { origin?: FieldOrigin }) {
